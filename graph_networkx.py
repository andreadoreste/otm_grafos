...
elist = [(1,2,5),(1,4,6),(2,3,9),(1,3,10),(4,5,9),(2,6,7),(6,7,8),(3,5,1),(4,10,5),(7,9,1),(10,12,4),(8,9,2),(9,11,1),(15,2,4),(15,6,5),(5,13,2),(14,11,3),(8,12,5),(12,11,2),(16,3,1),(16,7,1),(16,9,1),(16,10,1),(17,13,3),(17,8,9),(18,4,2),(18,2,1),(18,1,3),(18,15,5),(19,6,6),(19,7,7),(20,12,1),(21,13,7),(10,8,4)]
G = nx.Graph()
...
#print G.nodes()
'''
G.add_edge('a','b', weight=5) ok
G.add_edge('a','d', weight=6) ok
G.add_edge('b','c', weight=9) ok
G.add_edge('a','c',weight=10) ok
G.add_edge('d','e',weight=9) ok
G.add_edge('b','f',weight=7) ok
G.add_edge('f','g',weight=8) ok
G.add_edge('c','e',weight=1) ok
G.add_edge('d','j',weight=5) ok
G.add_edge('g','i',weight=1) ok
G.add_edge('j','h',weight=4) ok
G.add_edge('h','i',weight=2) ok
G.add_edge('i','l',weight=1) ok
